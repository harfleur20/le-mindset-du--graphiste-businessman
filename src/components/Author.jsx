      ...
      <div className="container">
        ...
        <div className="author-content fade-in">
          ...
          <div className="author-info">
            ...
            <p className="author-bio">Graphiste et développeur web camerounais dont le parcours incarne la résilience et la transformation. Parti avec peu de moyens (son premier emploi étant payé en sandwich), il a su tirer parti des difficultés du marché africain pour structurer son activité et adopter une vision stratégique.</p>
            <p className="author-bio">Dans son livre, il partage comment il a bâti un système lui permettant de générer des gains complémentaires par mois, en adoptant un véritable état d'esprit de businessman. Son objectif : prouver qu'en Afrique, il est possible de vivre de sa passion grâce à la discipline, à l'intelligence et à un bon accompagnement.</p>
            <div className="author-stats">
              <div className="stat">
                <span className="stat-value">100+</span>
                <span className="stat-label">design réalisés</span>
              </div>
              <div className="stat">
